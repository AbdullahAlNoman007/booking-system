...
router.post('/create-booking', (0, auth_1.default)(userRole_1.userRole.customer), (0, validationRequest_1.default)(booking_validation_1.bookingValidation.TbookingValidationSchema), booking_controller_1.bookingController.createBooking);
router.post('/create-bookingByoperator', (0, auth_1.default)(userRole_1.userRole.operator), (0, validationRequest_1.default)(booking_validation_1.bookingValidation.TbookingOperatorValidationSchema), booking_controller_1.bookingController.createBooking);
