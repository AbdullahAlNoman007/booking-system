...
router.get('/get-operator', (0, auth_1.default)(userRole_1.userRole.admin, userRole_1.userRole.moderator), (0, validationRequest_1.default)(member_validation_1.getValidationSchema), member_controller_1.memberController.getAOperator);
router.get('/get-operators', (0, auth_1.default)(userRole_1.userRole.admin, userRole_1.userRole.moderator), member_controller_1.memberController.getAllOperator);
...
router.put('/update-operator/:id', (0, auth_1.default)(userRole_1.userRole.admin, userRole_1.userRole.moderator), (0, validationRequest_1.default)(member_validation_1.memberUpdateSchema), member_controller_1.memberController.updateOperator);
