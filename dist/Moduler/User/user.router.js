...
router.post('/create-operator', (0, auth_1.default)(userRole_1.userRole.admin), (0, validationRequest_1.default)(user_validation_1.MemberValidationSchema), user_controller_1.userController.createOperator);
